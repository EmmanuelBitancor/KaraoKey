    ...
    >
      ...
      >
        <div className="flex items-center justify-between border-b border-white/10 px-6 py-4">
          ...
          <button
            onClick={onClose}
            className="text-white/50 hover:text-white transition text-2xl leading-none"
            title="Close"
          >
            &times;
          </button>
        ...
        <div className="max-h-[calc(90vh-13rem)] overflow-y-auto px-6 py-4">
          <div className="mb-4 flex items-center justify-between">
            ...
            <button
              onClick={onAddPlayer}
              className="flex items-center gap-1.5 rounded-full bg-[#FF6B00] px-3 py-1.5 text-xs font-semibold text-white hover:bg-[#e55f00] transition"
            >
        ...
        <div className="flex items-center justify-between border-t border-white/10 px-6 py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={onStart}
              disabled={!canStart}
              className="flex items-center gap-2 rounded-full bg-[#FF6B00] px-5 py-2.5 text-sm font-bold text-white shadow-lg transition hover:bg-[#e55f00] disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-[#FF6B00]"
            >
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
