    ...
    <div className="mt-10 rounded-2xl border border-white/10 bg-[#1a1a1a] p-6">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <button
          onClick={onStart}
          disabled={!canStart}
          className="flex items-center gap-2 rounded-full bg-[#FF6B00] px-6 py-3 text-sm font-bold text-white shadow-lg transition hover:bg-[#e55f00] disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-[#FF6B00] tv-card"
          tabIndex={0}
          role="button"
        >
